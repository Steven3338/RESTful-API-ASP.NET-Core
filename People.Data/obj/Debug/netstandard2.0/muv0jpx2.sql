...
CREATE TABLE [Addresses] (
    ...
    [CustomerId] int NOT NULL,
    [LastModified] datetime2 NOT NULL,
    [VitalSigynEmployeeId] int NULL,
    CONSTRAINT [PK_Addresses] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_Addresses_Customers_CustomerId] FOREIGN KEY ([CustomerId]) REFERENCES [Customers] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_Addresses_VitalSigynEmployees_VitalSigynEmployeeId] FOREIGN KEY ([VitalSigynEmployeeId]) REFERENCES [VitalSigynEmployees] ([Id]) ON DELETE NO ACTION
);
...
VALUES (N'20190320142647_init', N'2.2.3-servicing-35854');
