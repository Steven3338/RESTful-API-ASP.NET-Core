...
VALUES (N'20190419175247_init', N'2.2.3-servicing-35854');

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20190420003901_ver2', N'2.2.3-servicing-35854');

GO

ALTER TABLE [Cases] ADD [Subject] nvarchar(max) NULL;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20190420013357_ver3', N'2.2.3-servicing-35854');
