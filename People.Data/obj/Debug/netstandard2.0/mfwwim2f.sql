...
CREATE TABLE [CustomerMesseges] (
    ...
    CONSTRAINT [FK_CustomerMesseges_ServiceProviderEmployees_ServiceProviderEmployeeId] FOREIGN KEY ([ServiceProviderEmployeeId]) REFERENCES [ServiceProviderEmployees] ([Id]) ON DELETE NO ACTION
);
...
CREATE INDEX [IX_CustomerMesseges_ServiceProviderEmployeeId] ON [CustomerMesseges] ([ServiceProviderEmployeeId]);
...
VALUES (N'20190320180950_init', N'2.2.3-servicing-35854');
