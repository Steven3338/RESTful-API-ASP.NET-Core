...
CREATE TABLE [NestedCustomerMessages] (
    ...
    CONSTRAINT [FK_NestedCustomerMessages_CustomerMessages_CustomerMessageId] FOREIGN KEY ([CustomerMessageId]) REFERENCES [CustomerMessages] ([Id]) ON DELETE CASCADE
);
...
CREATE TABLE [ServiceProviderMessages] (
    [Id] int NOT NULL IDENTITY,
    [DateTimeOfInitialMessage] nvarchar(max) NULL,
    [TimeToResolution] nvarchar(max) NULL,
    [Resolved] bit NOT NULL,
    ...
    CONSTRAINT [PK_ServiceProviderMessages] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_ServiceProviderMessages_ServiceProviderEmployees_ServiceProviderEmployeeId] FOREIGN KEY ([ServiceProviderEmployeeId]) REFERENCES [ServiceProviderEmployees] ([Id]) ON DELETE NO ACTION
);
...
CREATE TABLE [CustomerServiceProviderMessages] (
    ...
    CONSTRAINT [FK_CustomerServiceProviderMessages_CustomerMessages_CustomerMessageId] FOREIGN KEY ([CustomerMessageId]) REFERENCES [CustomerMessages] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_CustomerServiceProviderMessages_ServiceProviderMessages_ServiceProviderMessageId] FOREIGN KEY ([ServiceProviderMessageId]) REFERENCES [ServiceProviderMessages] ([Id]) ON DELETE CASCADE
);
...
CREATE TABLE [NestedServiceProviderMessages] (
    ...
    CONSTRAINT [FK_NestedServiceProviderMessages_ServiceProviderMessages_ServiceProviderMessageId] FOREIGN KEY ([ServiceProviderMessageId]) REFERENCES [ServiceProviderMessages] ([Id]) ON DELETE CASCADE
);
...
CREATE INDEX [IX_ServiceProviderMessages_ServiceProviderEmployeeId] ON [ServiceProviderMessages] ([ServiceProviderEmployeeId]);

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20190320193151_init', N'2.2.3-servicing-35854');
