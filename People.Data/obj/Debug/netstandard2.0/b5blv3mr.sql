...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20190420013621_init')
BEGIN
    CREATE TABLE [Users] (
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20190420013621_init')
BEGIN
    CREATE UNIQUE INDEX [IX_UserEmployeers_UserId] ON [UserEmployeers] ([UserId]);
END;
...
BEGIN
    ...
    VALUES (N'20190420013621_init', N'2.2.3-servicing-35854');
END;

GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20190420154840_corrections')
BEGIN
    DROP INDEX [IX_UserEmployeers_UserId] ON [UserEmployeers];
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20190420154840_corrections', N'2.2.3-servicing-35854');
END;

GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20190420170726_Updated User Class')
BEGIN
    EXEC sp_rename N'[Users].[LogIn]', N'Admin', N'COLUMN';
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20190420170726_Updated User Class', N'2.2.3-servicing-35854');
END;
