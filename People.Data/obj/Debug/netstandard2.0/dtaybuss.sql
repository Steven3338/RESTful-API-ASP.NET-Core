...
CREATE TABLE [ServiceProviderMessages] (
    ...
    [TimeToResolution] nvarchar(max) NULL,
    [Resolved] bit NOT NULL,
    [ServiceProviderEmployeeId] int NOT NULL,
    [LastModified] datetime2 NOT NULL,
    CONSTRAINT [PK_ServiceProviderMessages] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_ServiceProviderMessages_ServiceProviderEmployees_ServiceProviderEmployeeId] FOREIGN KEY ([ServiceProviderEmployeeId]) REFERENCES [ServiceProviderEmployees] ([Id]) ON DELETE CASCADE
);
...
VALUES (N'20190320234655_init', N'2.2.3-servicing-35854');
